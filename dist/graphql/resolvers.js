...
exports.resolvers = {
    ...
    Product: {
        customers: (parent) => __awaiter(void 0, void 0, void 0, function* () { return yield customer_controller_1.default.getCustomerById(parent.customerId); }),
    },
    Customer: {
        products: (parent) => __awaiter(void 0, void 0, void 0, function* () { return yield product_controller_1.default.getProductById(parent.productId); }),
    },
    Order: {
    ...
    Mutation: {
        ...
        editOrder: (_1, _a) => __awaiter(void 0, [_1, _a], void 0, function* (_, { id, productId, customerId }) {
            return yield order_controller_1.default.updateOrder(id, {
                customerId,
                productId,
            });
        }),
